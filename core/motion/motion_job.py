"""Execution job tracking structure for body motion generation requests.
"""
...
class MotionJob:
    """Tracks state and progress parameters for a background body animation generation task."""

    def __init__(self, config: MotionConfig, job_id: Optional[str] = None) -> None:
        """Initialize MotionJob.
